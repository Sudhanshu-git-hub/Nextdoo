...
export function ConnectedToday({revision}:{revision:number}) {
  ...
  const sections=[['upcoming','Upcoming tasks','/tasks'],['goals','Goals for your work','/goals'],['trackers','Tracker today','/trackers'],['knowledge','References for your work','/knowledge'],['calendar','Calendar today','/calendar'],['dates','Dates in the next week','/calendar']] as const;
